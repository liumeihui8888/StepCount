...
public class Entry implements android.os.Parcelable {
    ...
    public com.github.mikephil.charting.data.Entry copy() {
        com.github.mikephil.charting.data.Entry e = new com.github.mikephil.charting.data.Entry(mVal, mXIndex, mData);
        return e;
    }
     ...
     * @return
     */
    public boolean equalTo(com.github.mikephil.charting.data.Entry e) {
    ...
    public static final android.os.Parcelable.Creator<com.github.mikephil.charting.data.Entry> CREATOR = new android.os.Parcelable.Creator<com.github.mikephil.charting.data.Entry>() {
        public com.github.mikephil.charting.data.Entry createFromParcel(android.os.Parcel source) {
            return new com.github.mikephil.charting.data.Entry(source);
        }

        public com.github.mikephil.charting.data.Entry[] newArray(int size) {
            return new com.github.mikephil.charting.data.Entry[size];
        }
    };
}
