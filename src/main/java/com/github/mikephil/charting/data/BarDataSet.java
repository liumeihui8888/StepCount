...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<com.github.mikephil.charting.data.BarEntry> {
    ...
    @Override
    public com.github.mikephil.charting.data.DataSet<BarEntry> copy() {

        java.util.List<BarEntry> yVals = new java.util.ArrayList<BarEntry>();

        for (int i = 0; i < mYVals.size(); i++) {
            yVals.add(((com.github.mikephil.charting.data.BarEntry) mYVals.get(i)).copy());
        }

        com.github.mikephil.charting.data.BarDataSet copied = new com.github.mikephil.charting.data.BarDataSet(yVals, getLabel());
    ...
    protected void calcMinMax(int start, int end) {
        ...
        for (int i = start; i <= endValue; i++) {
            ...
            com.github.mikephil.charting.data.BarEntry e = mYVals.get(i);
