...
public class Approximator {
    ...
    private com.github.mikephil.charting.data.filter.Approximator.ApproximatorType mType = com.github.mikephil.charting.data.filter.Approximator.ApproximatorType.DOUGLAS_PEUCKER;
     ...
     */
    public Approximator() {
        this.mType = com.github.mikephil.charting.data.filter.Approximator.ApproximatorType.NONE;
    }
     ...
     * @param type
     */
    public Approximator(com.github.mikephil.charting.data.filter.Approximator.ApproximatorType type, double tolerance) {
     ...
     * @param tolerance
     */
    public void setup(com.github.mikephil.charting.data.filter.Approximator.ApproximatorType type, double tolerance) {
        mType = type;
     ...
     * @param type
     */
    public void setType(com.github.mikephil.charting.data.filter.Approximator.ApproximatorType type) {
        this.mType = type;
    }
