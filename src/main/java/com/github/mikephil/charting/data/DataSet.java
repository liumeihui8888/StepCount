 ...
 */
public abstract class DataSet<T extends com.github.mikephil.charting.data.Entry> {
    ...
    protected void calcMinMax(int start, int end) {
        ...
        for (int i = start; i <= endValue; i++) {
            ...
            com.github.mikephil.charting.data.Entry e = mYVals.get(i);
    ...
    public float getYValForXIndex(int xIndex) {
        ...
        com.github.mikephil.charting.data.Entry e = getEntryForXIndex(xIndex);
    ...
    public void addEntry(com.github.mikephil.charting.data.Entry e) {
     ...
     */
    @SuppressWarnings("unchecked")
    public void addEntryOrdered(com.github.mikephil.charting.data.Entry e) {
     ...
     * @return
     */
    public int getEntryPosition(com.github.mikephil.charting.data.Entry e) {
     ...
     * @return
     */
    public boolean contains(com.github.mikephil.charting.data.Entry e) {

        for (com.github.mikephil.charting.data.Entry entry : mYVals) {
            if (entry.equals(e))
                return true;
        }
