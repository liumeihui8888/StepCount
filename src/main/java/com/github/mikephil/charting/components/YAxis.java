...
public class YAxis extends AxisBase {
	...
	private com.github.mikephil.charting.components.YAxis.YAxisLabelPosition mPosition = com.github.mikephil.charting.components.YAxis.YAxisLabelPosition.OUTSIDE_CHART;
	...
	public YAxis(com.github.mikephil.charting.components.YAxis.AxisDependency position) {
		super();
	 ...
	 * @param pos
	 */
	public void setPosition(com.github.mikephil.charting.components.YAxis.YAxisLabelPosition pos) {
		mPosition = pos;
	}
	...
	public boolean needsOffset() {
		if (isEnabled() && isDrawLabelsEnabled() && getLabelPosition() == com.github.mikephil.charting.components.YAxis.YAxisLabelPosition.OUTSIDE_CHART)
			return true;
		else
			return false;
	}
