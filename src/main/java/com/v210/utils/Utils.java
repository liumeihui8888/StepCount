...
public class Utils
{
	...
	public static Bitmap createReflectedImage(final Bitmap originalImage)
	{
		...
		final Bitmap reflectionImage = Bitmap.createBitmap(originalImage, 0, height / 4, width, height / 4, matrix, false);
		...
		final LinearGradient shader = new LinearGradient(0, originalImage.getHeight(), 0, bitmapWithReflection.getHeight() + reflectionGap, 0x70ffffff,
	...
	{
		ConnectivityManager cm = (ConnectivityManager) FrameApplication.getInstance()
     ...
     * @return
     */
	public static Object jsonToObj(final String data, final Class<?> className)
	{
	...
	{
		Gson mGson =new com.google.gson.Gson();
