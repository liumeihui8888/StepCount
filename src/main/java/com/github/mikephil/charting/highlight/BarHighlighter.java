...
public class BarHighlighter extends ChartHighlighter<BarDataProvider> {
	...
	@Override
	public com.github.mikephil.charting.highlight.Highlight getHighlight(float x, float y) {

		com.github.mikephil.charting.highlight.Highlight h = super.getHighlight(x, y);
	 ...
	 * @return
	 */
	protected com.github.mikephil.charting.highlight.Highlight getStackedHighlight(com.github.mikephil.charting.highlight.Highlight old, com.github.mikephil.charting.data.BarDataSet set, int xIndex, int dataSetIndex, double yValue) {
		...
		com.github.mikephil.charting.highlight.Range[] ranges = getRanges(entry);
		int stackIndex = getClosestStackIndex(ranges, (float) yValue);

		com.github.mikephil.charting.highlight.Highlight h = new com.github.mikephil.charting.highlight.Highlight(xIndex, dataSetIndex, stackIndex, ranges[stackIndex]);
		return h;
	}
	 ...
	 * @return
	 */
	protected com.github.mikephil.charting.highlight.Range[] getRanges(com.github.mikephil.charting.data.BarEntry entry) {
		...
		com.github.mikephil.charting.highlight.Range[] ranges = new com.github.mikephil.charting.highlight.Range[values.length];
		...
		for (int i = 0; i < ranges.length; i++) {
			...
			if (value < 0) {
				ranges[i] = new com.github.mikephil.charting.highlight.Range(negRemain, negRemain + Math.abs(value));
				negRemain += Math.abs(value);
			} else {
				ranges[i] = new com.github.mikephil.charting.highlight.Range(posRemain, posRemain + value);
				posRemain += value;
			}
		}
