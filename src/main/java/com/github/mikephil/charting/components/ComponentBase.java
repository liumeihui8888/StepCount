...
public abstract class ComponentBase {
     ...
     */
    protected int mTextColor = android.graphics.Color.BLACK;
    ...
    public void setXOffset(float xOffset) {
        mXOffset = com.github.mikephil.charting.utils.Utils.convertDpToPixel(xOffset);
    }
    ...
    public void setYOffset(float yOffset) {
        mYOffset = com.github.mikephil.charting.utils.Utils.convertDpToPixel(yOffset);
    }
    ...
    public void setTextSize(float size) {
        ...
        mTextSize = com.github.mikephil.charting.utils.Utils.convertDpToPixel(size);
    }
