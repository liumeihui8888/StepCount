...
public class PieDataSet extends com.github.mikephil.charting.data.DataSet<Entry> {
    ...
    public PieDataSet(java.util.List<com.github.mikephil.charting.data.Entry> yVals, String label) {
        super(yVals, label);
//        mShift = Utils.convertDpToPixel(12f);
    ...
    public com.github.mikephil.charting.data.DataSet<Entry> copy() {
        ...
        com.github.mikephil.charting.data.PieDataSet copied = new com.github.mikephil.charting.data.PieDataSet(yVals, getLabel());
