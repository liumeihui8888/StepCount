...
public class Highlight {
     ...
     */
    public Highlight(int x, int dataSet, int stackIndex, com.github.mikephil.charting.highlight.Range range) {
     ...
     * @return
     */
    public boolean equalTo(com.github.mikephil.charting.highlight.Highlight h) {
