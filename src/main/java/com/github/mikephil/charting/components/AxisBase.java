...
public abstract class AxisBase extends ComponentBase {
	...
	private int mGridColor = android.graphics.Color.GRAY;

    private float mGridLineWidth = 1f;

    private int mAxisLineColor = android.graphics.Color.GRAY;
    ...
    /** default constructor */
    public AxisBase() {
        this.mTextSize = com.github.mikephil.charting.utils.Utils.convertDpToPixel(10f);
        this.mXOffset = com.github.mikephil.charting.utils.Utils.convertDpToPixel(5f);
        this.mYOffset = com.github.mikephil.charting.utils.Utils.convertDpToPixel(5f);
		this.mLimitLines = new java.util.ArrayList<LimitLine>();
	}
    ...
    public void setAxisLineWidth(float width) {
        mAxisLineWidth = com.github.mikephil.charting.utils.Utils.convertDpToPixel(width);
    }
    ...
    public void setGridLineWidth(float width) {
        mGridLineWidth = com.github.mikephil.charting.utils.Utils.convertDpToPixel(width);
    }
	...
	public void addLimitLine(LimitLine l) {
		...
		if (mLimitLines.size() > 6) {
			android.util.Log.e("MPAndroiChart",
    ...
    public void enableGridDashedLine(float lineLength, float spaceLength, float phase) {
        mGridDashPathEffect = new android.graphics.DashPathEffect(new float[] {
