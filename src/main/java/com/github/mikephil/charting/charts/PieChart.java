 ...
 */
public class PieChart extends PieRadarChartBase<com.github.mikephil.charting.data.PieData> {

    /**
     * rect object that represents the bounds of the piechart, needed for
     * drawing the circle
     */
    private android.graphics.RectF mCircleBox = new android.graphics.RectF();
     ...
     */
    private android.text.SpannableString mCenterText = new android.text.SpannableString("");
    ...
    protected float[] getMarkerPosition(com.github.mikephil.charting.data.Entry e, Highlight highlight) {
        ...
        android.graphics.PointF center = getCenterCircleBox();
        float r = getRadius();
    ...
    private void calcAngles() {
        ...
        java.util.List<com.github.mikephil.charting.data.PieDataSet> dataSets = mData.getDataSets();

        int cnt = 0;

        for (int i = 0; i < mData.getDataSetCount(); i++) {

            com.github.mikephil.charting.data.PieDataSet set = dataSets.get(i);
            java.util.List<com.github.mikephil.charting.data.Entry> entries = set.getYVals();
    ...
    public int getIndexForAngle(float angle) {
        ...
        float a = com.github.mikephil.charting.utils.Utils.getNormalizedAngle(angle - getRotationAngle());
    ...
    public int getDataSetIndexForIndex(int xIndex) {
        ...
        java.util.List<? extends com.github.mikephil.charting.data.DataSet<? extends com.github.mikephil.charting.data.Entry>> dataSets = mData.getDataSets();
    ...
    public void setHoleColorTransparent(boolean enable) {
        if (enable) {
            ...
            ((PieChartRenderer) mRenderer).getPaintHole().setXfermode(
                    new android.graphics.PorterDuffXfermode(android.graphics.PorterDuff.Mode.CLEAR));
        } else {
            ((PieChartRenderer) mRenderer).getPaintHole().setXfermode(null);
        }
    }
    ...
    public void setCenterText(android.text.SpannableString text) {
        ...
        if (text == null)
            mCenterText = new android.text.SpannableString("");
        else
            mCenterText = text;
    }
    ...
    public void setCenterText(String text) {
        setCenterText(new android.text.SpannableString(text));
    }
     ...
     * @return
     */
    public android.text.SpannableString getCenterText() {
        return mCenterText;
    }
    ...
    public android.graphics.PointF getCenterCircleBox() {
        return new android.graphics.PointF(mCircleBox.centerX(), mCircleBox.centerY());
    }
    ...
    public void setCenterTextSize(float sizeDp) {
        ((PieChartRenderer) mRenderer).getPaintCenterText().setTextSize(
                com.github.mikephil.charting.utils.Utils.convertDpToPixel(sizeDp));
    }
    ...
    public void setTransparentCircleColor(int color) {
        ...
        android.graphics.Paint p = ((PieChartRenderer) mRenderer).getPaintTransparentCircle();
