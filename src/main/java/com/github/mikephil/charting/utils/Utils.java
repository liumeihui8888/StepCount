...
public abstract class Utils {
     ...
     * @return
     */
    public static com.github.mikephil.charting.utils.FSize calcTextSize(android.graphics.Paint paint, String demoText) {

        android.graphics.Rect r = new android.graphics.Rect();
        paint.getTextBounds(demoText, 0, demoText.length(), r);
        return new com.github.mikephil.charting.utils.FSize(r.width(), r.height());
    }
    ...
    public static void drawText(android.graphics.Canvas c, String text, float x, float y, android.graphics.Paint paint, android.graphics.PointF anchor, float angleDegrees) {
        ...
        if (angleDegrees != 0.f) {
            ...
            if (anchor.x != 0.5f || anchor.y != 0.5f) {
                final com.github.mikephil.charting.utils.FSize rotatedSize = getSizeOfRotatedRectangleByDegrees(
    ...
    public static com.github.mikephil.charting.utils.FSize getSizeOfRotatedRectangleByDegrees(com.github.mikephil.charting.utils.FSize rectangleSize, float degrees)
    {
    ...
    public static com.github.mikephil.charting.utils.FSize getSizeOfRotatedRectangleByRadians(com.github.mikephil.charting.utils.FSize rectangleSize, float radians)
    {
        return getSizeOfRotatedRectangleByRadians(rectangleSize.width, rectangleSize.height, radians);
    }

    public static com.github.mikephil.charting.utils.FSize getSizeOfRotatedRectangleByDegrees(float rectangleWidth, float rectangleHeight, float degrees)
    {
        final float radians = degrees * FDEG2RAD;
        return getSizeOfRotatedRectangleByRadians(rectangleWidth, rectangleHeight, radians);
    }

    public static com.github.mikephil.charting.utils.FSize getSizeOfRotatedRectangleByRadians(float rectangleWidth, float rectangleHeight, float radians)
    {
        return new com.github.mikephil.charting.utils.FSize(
