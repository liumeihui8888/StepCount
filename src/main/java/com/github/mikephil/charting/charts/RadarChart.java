 ...
 */
public class RadarChart extends PieRadarChartBase<com.github.mikephil.charting.data.RadarData> {
     ...
     */
    private int mWebColor = android.graphics.Color.rgb(122, 122, 122);

    /**
     * color for the inner web
     */
    private int mWebColorInner = android.graphics.Color.rgb(122, 122, 122);
    ...
    public RadarChart(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
    }

    public RadarChart(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mWebLineWidth = com.github.mikephil.charting.utils.Utils.convertDpToPixel(1.5f);
        mInnerWebLineWidth = com.github.mikephil.charting.utils.Utils.convertDpToPixel(0.75f);
    ...
    protected float[] getMarkerPosition(com.github.mikephil.charting.data.Entry e, Highlight highlight) {
        ...
        android.graphics.PointF p = new android.graphics.PointF((float) (c.x + val * Math.cos(Math.toRadians(angle))),
...
//        }
    ...
    public void setWebLineWidth(float width) {
        mWebLineWidth = com.github.mikephil.charting.utils.Utils.convertDpToPixel(width);
    }
    ...
    public void setWebLineWidthInner(float width) {
        mInnerWebLineWidth = com.github.mikephil.charting.utils.Utils.convertDpToPixel(width);
    }
    ...
    protected float getRequiredBaseOffset() {
        return mXAxis.isEnabled() && mXAxis.isDrawLabelsEnabled() ?
                ...
                com.github.mikephil.charting.utils.Utils.convertDpToPixel(10f);
    }
