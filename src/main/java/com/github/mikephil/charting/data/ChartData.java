 ...
 */
public abstract class ChartData<T extends com.github.mikephil.charting.data.DataSet<? extends Entry>> {
    ...
    public void calcMinMax(int start, int end) {
        ...
        if (mDataSets == null || mDataSets.size() < 1) {
            ...
            if (firstLeft != null) {
                ...
                for (com.github.mikephil.charting.data.DataSet<?> dataSet : mDataSets) {
     ...
     * @param dataSetIndex
     */
    public void addEntry(com.github.mikephil.charting.data.Entry e, int dataSetIndex) {
    ...
    public boolean removeEntry(int xIndex, int dataSetIndex) {
        ...
        com.github.mikephil.charting.data.Entry e = dataSet.getEntryForXIndex(xIndex);
     ...
     * @return
     */
    public T getDataSetForEntry(com.github.mikephil.charting.data.Entry e) {
    ...
    public void setValueFormatter(ValueFormatter f) {
        if (f == null)
            ...
            for (com.github.mikephil.charting.data.DataSet<?> set : mDataSets) {
