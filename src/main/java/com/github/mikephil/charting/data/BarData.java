...
public class BarData extends BarLineScatterCandleBubbleData<BarDataSet> {
    ...
    public BarData(java.util.List<String> xVals) {
        super(xVals);
    }
    ...
    public BarData(java.util.List<String> xVals, java.util.List<com.github.mikephil.charting.data.BarDataSet> dataSets) {
        super(xVals, dataSets);
    }

    public BarData(String[] xVals, java.util.List<com.github.mikephil.charting.data.BarDataSet> dataSets) {
        super(xVals, dataSets);
    }

    public BarData(java.util.List<String> xVals, BarDataSet dataSet) {
    ...
    private static java.util.List<com.github.mikephil.charting.data.BarDataSet> toList(BarDataSet dataSet) {
        java.util.List<com.github.mikephil.charting.data.BarDataSet> sets = new java.util.ArrayList<com.github.mikephil.charting.data.BarDataSet>();
        sets.add(dataSet);
        return sets;
    }
