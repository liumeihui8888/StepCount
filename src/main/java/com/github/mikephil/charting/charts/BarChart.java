 ...
 */
public class BarChart extends BarLineChartBase<com.github.mikephil.charting.data.BarData> implements BarDataProvider
{
    ...
    public BarChart(android.content.Context context, android.util.AttributeSet attrs)
    {
        super(context, attrs);
    }

    public BarChart(android.content.Context context, android.util.AttributeSet attrs, int defStyle)
    {
